  ...
  return (
    <div className="home-container">
      ...
      <div className="content">
        ...
        {activeTab === 'code' && (
          <div className="tab-content">
            ...
            <p>Generate and debug code with AI assistance.</p>
            <div className="feature-coming">✨ Feature Coming Soon</div>
          </div>
        )}
      </div>
      ...
      <style jsx>{`
        ...
        .tabs { display: flex; gap: 10px; padding: 20px 40px; background: white; border-bottom: 1px solid #eee; flex-wrap: wrap; }
        .tab { padding: 10px 20px; background: #f0f0f0; border: none; border-radius: 24px; cursor: pointer; transition: all 0.3s; font-size: 14px; font-weight: 500; }
        ...
        @media (max-width: 768px) { .navbar { padding: 15px 20px; flex-direction: column; gap: 10px; } }
      `}</style>
    </div>
  );
}
